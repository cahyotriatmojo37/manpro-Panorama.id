...
$ambil = $db->query("SELECT * FROM pembelian JOIN pelanggan ON pembelian.id_pelanggan=pelanggan.id
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $detail['nomer']; ?></td>
                                <td><?php echo $detail['email']; ?></td>
                                <td><?php echo $detail['alamat_penjemputan']; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <section class="panel">
                      <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                          ...
                          <?php $ambil = $db->query("SELECT * FROM pembelian_produk JOIN produk ON pembelian_produk.id_produk=produk.id
                                                    WHERE pembelian_produk.id_pembelian='$_GET[id]'"); ?>       <!-- id punya nya idproduk -->
