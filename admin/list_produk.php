              ...
              <table class="table table-responsive">
                ...
                <tbody>
                  ...
                  while ($barang = mysqli_fetch_array($query)) {
                    ...
                    echo "<td>" . $barang['singkat'] . "</td>";
                    echo "<td>" . $barang['deskripsi'] . "</td>";
                    echo "<td>" . "Rp. " . $barang['harga'] . "</td>";
                  ?>
                    <td>
                      <img src="../assets/gambar/produk/<?php echo $barang['foto']; ?>" width="100px">
                    </td>
                  <?php
                    echo "<td>";
                    echo "<a class='btn btn-danger' href='hapus.php?id=" . $barang['id'] . "' data-toggle='tooltip' title='Hapus!'><i class='bi bi-x'></i></a>";
                    echo "<a class='btn btn-success' href='form_edit.php?id=" . $barang['id'] . "' data-toggle='tooltip' title='Edit!'><i class='bi bi-pen'></i></a>";
                    echo "</td>";
                    echo "</tr>";
                  }
                  ?>
